...
function initCTAModal() {
    ...
    const allCTAButtons = Array.from(new Set([
        ...
        ...document.querySelectorAll('[data-action="demo"]')
    ]));
    
    console.log(`Found ${allCTAButtons.length} total CTA buttons`);
    ...
    document.addEventListener('click', function(e) {
        ...
        if (target) {
            ...
            if (target.type === 'submit') {
                console.log('Fallback: Skipping submit button');
                return;
            }
